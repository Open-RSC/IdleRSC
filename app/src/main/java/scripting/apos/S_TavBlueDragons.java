...
/**
 * taverly dungeon blue dragons - option for food or pray pots and how many of each - support for
 * cakes - kills dragons and buries/banks bones - goes to bank when full inv of loot or out of food
 * - teles fally to bank - hops world if no dragons around
 *
 * <p>start by either ladder or on the south-east tile of the members gate
 *
 * <p>105+ combat highly recommended
 *
 * @author Storm
 */
// 370 3355
public final class S_TavBlueDragons extends Script implements ActionListener {
  ...
  public S_TavBlueDragons(String ex) {
    //        super(ex);
  ...
  public int main() {
    ...
    if (is_underground()) {
      ...
      if ((food_count > 0 && food_index == -1) || (ppot_count > 0 && ppot_index == -1) /*||
