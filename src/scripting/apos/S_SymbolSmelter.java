...
public final class S_SymbolSmelter extends Script implements ActionListener {
  ...
  private static final String[] symbol_names = {"holy", "unholy"};
  ...
  public S_SymbolSmelter(String ex) {
    //        super(ex);
  ...
  public void paint() {
    ...
    for (int i = 0; i < symbol_names.length; ++i) {
      ...
      drawString("Banked " + symbol_names[i] + " symbols: " + banked_counts[i], 25, y, 1, 0xFFFFFF);
      y += 15;
    }
  }
