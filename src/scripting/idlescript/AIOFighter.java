...
//        			break;
    ...
    public void setupGUI() { 	
    	...
    	JTextField npcIdsField = new JTextField("3,4,6,11,23");
    	JLabel maxWanderLabel = new JLabel("Max Wander Distance: (-1 to disable)");
    	JTextField maxWanderField = new JTextField("40");
    	...
    	JCheckBox buryBonesCheckbox = new JCheckBox("Bury Bones? (prioritizes looting bones over ALL combat!)");
