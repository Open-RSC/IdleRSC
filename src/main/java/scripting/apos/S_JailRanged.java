...
public final class S_JailRanged extends Script {
  ...
  private static final int[] invalid_npc = {-1, -1, -1};
  ...
  static {
    ...
    tiles.put(
        ID_MUGGER,
        new Point[] {
          new Point(281, 665), new Point(285, 662), new Point(285, 663), new Point(285, 664)
        });
    tiles.put(ID_KNIGHT, new Point[] {new Point(281, 665), new Point(281, 667)});
  }
