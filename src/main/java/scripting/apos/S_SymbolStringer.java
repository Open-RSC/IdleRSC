...
public final class S_SymbolStringer extends Script {
  ...
  private static final String[] names = {"holy", "unholy"};

  private static final int[] unstrung_ids = {44, 1027};

  private static final int[] strung_ids = {45, 1028};
  ...
  public void paint() {
    ...
    for (int i = 0; i < names.length; ++i) {
      ...
      y += 15;
      drawString("Banked " + names[i] + " symbols: " + banked_counts[i], 25, y, 1, white);
    }
    y += 15;
  }
