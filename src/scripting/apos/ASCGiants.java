...
//        super(var1);
    ...
    public void init(String var1) {
        ...
        String var3 = (String)JOptionPane.showInputDialog((Component)null, "Where are we starting?", "Fire Giants", -1, (Icon)null, var2, var2[2]);
        Object[] var4 = new Object[]{"Attack", "Strength", "Defense", "Controlled"};
        String var5 = (String)JOptionPane.showInputDialog((Component)null, "Choose FightMode", "Fire Giants", -1, (Icon)null, var4, var4[0]);
        if (var3.equals("Bank")) {
    ...
    public void paint() {
        ...
        short var2 = 315;
        int var5 = var1 + 15;
        this.drawString("@whi@Obtained@red@ " + this.dsq + " @whi@Left Halves.", var2, var5, 1, 16754176);
        var5 += 15;
        this.drawString("@whi@Obtained@red@ " + this.dmed + " @whi@Dragon mediums.", var2, var5, 1, 16754176);
        var5 += 15;
        this.drawString("@whi@Obtained@red@ " + this.rscim + " @whi@Rune Scims.", var2, var5, 1, 16754176);
        var5 += 15;
        this.drawString("@whi@Obtained@red@ " + this.r2h + " @whi@R2hs.", var2, var5, 1, 16754176);
        var5 += 15;
        this.drawString("@whi@Obtained@red@ " + this.rkite + " @whi@Rune kites.", var2, var5, 1, 16754176);
        var5 += 15;
        this.drawString("@whi@Obtained@red@ " + this.rbaxe + " @whi@Rune Battleaxe's.", var2, var5, 1, 16754176);
        var5 += 15;
        this.drawString("@whi@Obtained@red@ " + this.rspear + " @whi@Rune Spears.", var2, var5, 1, 16754176);
        var5 += 15;
        this.drawString("@whi@Obtained@red@ " + this.loop + " @whi@Half Key (loop).", var2, var5, 1, 16754176);
        var5 += 15;
        this.drawString("@whi@Obtained@red@ " + this.teeth + " @whi@Half Key (teeth).", var2, var5, 1, 16754176);
        var5 += 15;
        this.drawString("@whi@Obtained@red@ " + this.firebstf + " @whi@Battlestaffs.", var2, var5, 1, 16754176);
        var5 += 15;
        ...
        var6 += 15;
        this.drawString("@whi@Buried:@red@ " + this.bonesburied + "@whi@ Bones (@red@" + (double)this.bonesburied * 12.5D + "@whi@ xp)", var3, var6, 1, 16777215);
        var6 += 15;
    ...
    private String getTimeRunning() {
        ...
        if (var1 >= 7200L) {
            return new String(var1 / 3600L + " hours, " + var1 % 3600L / 60L + " minutes, " + var1 % 60L + " seconds.");
        } else if (var1 >= 3600L && var1 < 7200L) {
            return new String(var1 / 3600L + " hour, " + var1 % 3600L / 60L + " minutes, " + var1 % 60L + " seconds.");
        } else {
            return var1 >= 60L ? new String(var1 / 60L + " minutes, " + var1 % 60L + " seconds.") : new String(var1 + " seconds.");
        }
    }
