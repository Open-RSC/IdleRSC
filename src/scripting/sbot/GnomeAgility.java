...
public class GnomeAgility extends Script {
  ...
  public void EnterPipe() {
    while (GetY() > 494) {
      AtObject(683, 497);
      long T = TickCount();
      while (GetY() > 494 && TickCount() - T < 8000) Wait(10);
    }
  }
  ...
  public void ClimbSecondNet() {
    while (GetY() > 501) {
      AtObject(683, 502);
      long T = TickCount();
      while (GetY() > 501 && TickCount() - T < 8000) Wait(10);
    }
  }
  ...
  public void ClimbDown() {
    while (GetY() != 506) {
      AtObject(683, 2396);
      long T = TickCount();
      while (GetY() != 506 && TickCount() - T < 2000) Wait(10);
    }
  }
  ...
  public void Swing() {
    while (GetX() != 685) {
      AtObject(689, 2395);
      long T = TickCount();
      while (GetX() != 685 && TickCount() - T < 8000) Wait(10);
    }
  }
  ...
  public void ClimbWatchTower() {
    while (GetY() != 2394) {
      AtObject(693, 1452);
      long T = TickCount();
      while (GetY() != 2394 && TickCount() - T < 8000) Wait(10);
    }
  }
  ...
  public void ClimbNet() {
    while (GetY() != 1448) {
      AtObject(692, 503);
      long T = TickCount();
      while (GetY() != 1448 && TickCount() - T < 8000) Wait(10);
    }
  }
  ...
  public void CrossLog() {
    while (GetY() != 499) {
      AtObject(692, 495);
      long T = TickCount();
      while (GetY() != 499 && TickCount() - T < 5000) Wait(10);
    }
  }
