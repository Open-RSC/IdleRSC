...
public final class S_Barbarian extends Script {
  ...
  public static final String[] combined_fish_spots = {"Trout/salmon", "Pike"};
  ...
  public void onServerMessage(String str) {
    ...
    // jump to drop here since bank is far
      ...
      if (cur_wcattempts >= 35) _woodcutCsvOut();
      ...
      if (cur_fmattempts >= 35) _firemakeCsvOut();
  ...
  public void paint() {
    ...
    drawString("Barbarian Script - @whi@" + stages.get(stage).toString(), x, y, 2, orangey);
    y += 15;
  ...
  private void create_frame() {
    ...
    final Checkbox power = new Checkbox("Power fish or eat cooked fish", dispose_group, true);
