 ...
 */
public final class PotionMaker extends SeattaScript {
  ...
  private final int[] startPos = {0, 0};
  private int made = 0;
  ...
  private void bank() {
    ...
    c.openBank();
    c.sleep(2 * 640);
    if (!c.isInBank()) c.sleepUntil(c::isInBank, 20000);
  ...
  public void paintInterrupt() {
    if (c != null) {
      ...
      if (!secondaryIngredientName.isEmpty()) {
