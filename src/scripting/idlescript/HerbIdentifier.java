...
public class HerbIdentifier extends IdleScript {
    ...
    public void questMessageInterrupt(String message) {
        if(message.contains("This herb is"))
        	identifiedCount++;
    }
    ...
    public void paintInterrupt() {
        if(controller != null) {
            ...
            controller.drawString("@yel@Herbs Identified: @whi@" + String.format("%,d", identifiedCount) + " @yel@(@whi@" + String.format("%,d", identifiedPerHr) + "@yel@/@whi@hr@yel@)", 10, 21+14, 0xFFFFFF, 1);
        }
    }
