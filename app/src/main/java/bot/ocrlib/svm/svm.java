...
class Solver {
  ...
  void Solve(
    ...
    int iter = 0;
    final int max_iter =
        Math.max(10000000, l > Integer.MAX_VALUE / 100 ? Integer.MAX_VALUE : 100 * l);
...
public class svm {
  ...
  private static void solve_c_svc(
    ...
    s.Solve(
        l, new SVC_Q(prob, param, y), minus_ones, y, alpha, Cp, Cn, param.eps, si, param.shrinking);
  ...
  private static void solve_nu_svc(
      svm_problem prob, svm_parameter param, double[] alpha, Solver.SolutionInfo si) {
    int i;
    final int l = prob.l;
    ...
    s.Solve(
        l, new SVC_Q(prob, param, y), zeros, y, alpha, 1.0, 1.0, param.eps, si, param.shrinking);
    final double r = si.r;
  ...
  private static void solve_one_class(
      svm_problem prob, svm_parameter param, double[] alpha, Solver.SolutionInfo si) {
    final int l = prob.l;
    final double[] zeros = new double[l];
  ...
  private static void solve_epsilon_svr(
      svm_problem prob, svm_parameter param, double[] alpha, Solver.SolutionInfo si) {
    final int l = prob.l;
  ...
  private static void solve_nu_svr(
      svm_problem prob, svm_parameter param, double[] alpha, Solver.SolutionInfo si) {
    final int l = prob.l;
  ...
  private static void svm_binary_svc_probability(
      svm_problem prob, svm_parameter param, double Cp, double Cn, double[] probAB) {
    int i;
    final int nr_fold = 5;
  ...
  private static void svm_group_classes(
      svm_problem prob,
      int[] nr_class_ret,
      int[][] label_ret,
      int[][] start_ret,
  ...
  public static void svm_cross_validation(
      svm_problem prob, svm_parameter param, int nr_fold, double[] target) {
    int i;
  ...
  public static double svm_predict_probability(
      svm_model model, svm_node[] x, double[] prob_estimates) {
      ...
      for (i = 0; i < nr_class; i++) {
        for (int j = i + 1; j < nr_class; j++) {
          pairwise_prob[i][j] =
              Math.min(
                  Math.max(
                      sigmoid_predict(dec_values[k], model.probA[k], model.probB[k]), min_prob),
                  1 - min_prob);
  ...
  public static void svm_save_model(String model_file_name, svm_model model) throws IOException {
    final DataOutputStream fp =
        new DataOutputStream(new BufferedOutputStream(new FileOutputStream(model_file_name)));
