...
public final class RomeoAndJuliet extends QuestHandler {
  ...
  private final int[] JULIET_DOOR_ONE = {166, 495};
  private final int[] JULIET_DOOR_TWO = {170, 498};
  private final int[] JULIET_DOOR_THREE = {170, 496};
  private final int[] JULIET_DOOR_FOUR = {168, 499};
  private final int[] CHURCH_DOOR_ONE = {107, 474};
  private final int[] CHURCH_DOOR_TWO = {107, 480};
  private final int[] CHURCH_DOOR_THREE = {104, 478};
  private final int[] CHURCH_DOOR_FOUR = {103, 474};

  private final int[] APOTHECARY_DOOR = {216, 2580};

  // ITEM IDS
  private final int CADAVABERRIES_ID = ItemId.CADAVABERRIES.getId();

  // NPC IDS
  private final int ROMEO_ID = NpcId.ROMEO.getId();
  private final int JULIET_ID = NpcId.JULIET.getId();
  private final int FATHER_LAWRENCE_ID = NpcId.FATHER_LAWRENCE.getId();
  private final int APOTHECARY_ID = NpcId.APOTHECARY.getId();

  // NPC DIALOGS
  private final String[] STEP_ONE_START_QUEST_DIALOG = {"Can I help find her for you?"};

  private void checkCadavaberries() {
