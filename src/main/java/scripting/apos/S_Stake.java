...
public final class S_Stake extends Script {
  ...
  private static final int[] prayers = {9, 10, 11};
  private static final int[] dstone_amulets = {597, 522};
  private static final int[] weapons = {DAXE, DSWORD, R2H, 1217, 1216, 1218};
  private static final int[] shields = {1278, 404};
  private static final int[] helms = {795, 112};
  private static final int[] body = {407, 401, CHAIN};
  private static final int[] legs = {402, 406};
  private static final int[] capes = {1288, 1215, 1214, 1213};
  private static final int[] amulets = {
    dstone_amulets[0], dstone_amulets[1], GNOME_AMULET, RUBY_AMULET
  };
  private static final int[] gauntlets = {698, 699, 700, 701, 1006};
  ...
  public void paint() {
    ...
    if (listen_input) {
      drawString(
          "Command@gre@:@whi@ " + input + ((ticks % 40) < 20 ? "" : "*"), 315, 50, 1, 0xFFFFFF);
    }
  }
}
