...
public class FoulRunecraft extends IdleScript {
  ...
  private final String[] types = {"Air", "Mind", "Water", "Earth", "Fire", "Body", "Cosmic", "Chaos", "Nature", "Mining"};
  ...
  private int craftingLoop() {
    ...
    if (choice == 8) {
      ...
      if (shopkeeper != null) {
        ...
        if (c.getInventoryItemCount(10) < 5 * (30 - c.getInventoryItemCount()) || c.getInventoryItemCount(1299) < 30 - c.getInventoryItemCount()) {
