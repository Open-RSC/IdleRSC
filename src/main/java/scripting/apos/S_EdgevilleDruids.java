...
public final class S_EdgevilleDruids extends Script {
  ...
  private static final int[] gate_path_y = {3296, 3284, 3276, 3273, 3273, 3266};
  ...
  public S_EdgevilleDruids(String ex) {
    //        super(ex);
  ...
  public void init(String args) {
    ...
    if (result == JOptionPane.YES_OPTION) {
      pickup =
          new int[] {165, 435, 436, 437, 438, 439, 440, 441, 442, 443, 469, 464, 466, 270, 40, 42};
    } else {
      pickup = new int[] {438, 439, 440, 441, 442, 443, 466, 40, 42};
    }
    cur_tile = 0;
    walking = false;
  }
  ...
  private int above_ground() {
    ...
    if ((food_to_withdraw > 0 && getInventoryIndex(food_id) == -1)
