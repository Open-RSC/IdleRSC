...
public final class S_KBDLooter extends Script implements ActionListener {
    ...
    if (e.getActionCommand().equals("OK")) {
      ...
      needs_sap =
          traded_sap =
              needs_sdp =
                  traded_sdp =
                      needs_ssp = traded_ssp = answer_trade = poisoned = traded_sharks = false;
