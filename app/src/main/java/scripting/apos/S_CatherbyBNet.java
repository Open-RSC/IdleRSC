...
public final class S_CatherbyBNet extends Script {
  ...
  public static final String[] other_loot_names = {
    "seaweed", "gloves", "boots", "oyster", "casket"
  };
  ...
  public S_CatherbyBNet(String ex) {
    //		super(ex);
    ...
    try {
      ...
      if (fileCreated) {
        fishcsv.write(
            "fish_spot,level,attempts,mackerel,cod,bass,seaweed,gloves,boots,oyster,casket\n");
        fishcsv.flush();
      }
  ...
  public void paint() {
    ...
    y += 15;
    drawString(
        String.format("%s %s", iformat.format(pearl_loot_count[0]), "Oyster"), x + 10, y, 2, white);
    y += 15;
    drawString(
        String.format("%s %s", iformat.format(casket_loot_count[0]), "Casket"),
        x + 10,
        y,
        2,
        white);
