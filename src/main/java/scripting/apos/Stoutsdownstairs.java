...
/**
 * This script is used to help you gain attack levels with out gaining any hitpoints exp.
 *
 * <p>if you run the script with the parameter "buy" make sure that you are near falador west bank
 * have money in your inventory and thats it
 *
 * <p>if you run the script with the parameter "train" make sure that you are near varrock east bank
 *
 * <p>if you want to use wine instead of beer to train change the variables below.
 *
 * <p>v 1.5
 *
 * <p>- yomama`
