...
//	}
	...
	/**
	 * Used internally by the bot to set {@link controller.Controller}, as that is what adapts APOS to IdleRSC.
	 *  
	 * @param _controller
	 */
...
//	}
	...
	public void useOnNpc(int local_index, int slot) {
		controller.useItemOnNpc(this.getNpcServerIndex(local_index), controller.getInventorySlotItemId(slot));
	}
...
//		}
//		return locRouteCalc.calculate(this.getAdjacency(), this.getLocalX(), this.getLocalY(), dx, dy, dx, dy, false) != -1;
	}
