...
public class GnomeFlaxx0r extends IdleScript {
    ...
    public int start(String parameters[]) {
		...
		controller.displayMessage("@red@Put true or false in Params. True to spin & bank flax, false to pick & bank flax.");
    ...
    public void paintInterrupt() {
        if(controller != null) {
            ...
            controller.drawString("@dgr@Gnome@cya@Flaxx0r @whi@by @red@Dvorak @whi@& @red@Kaila", 10, 21, 0xFFFFFF, 1);
            if(spin) {
