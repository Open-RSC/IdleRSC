 ...
 *
 * <p>Start in Edge bank or Uni's with Gear. Sharks IN BANK REQUIRED. Teleport if Pkers Attack
 * Option. 31 Magic, Laws, Airs, and Earths required for Escape Tele. Unselected, bot WALKS to Edge
 * when Attacked. Selected, bot walks to 19 wildy and teleports. Return to Hobs Mine after
 * Escaping?", true. Unselected, bot will log out after escaping Pkers. Selected, bot will grab more
 * food and return.
 *
 * <p>Author - Kaila
 */
  ...
  public void paintInterrupt() {
    if (controller != null) {
      ...
      controller.drawString(
          "@whi@Horns in Bank: @gre@" + String.valueOf(this.uniInBank), 350, 62, 0xFFFFFF, 1);
      controller.drawString(
          "@whi@Horns Picked: @gre@"
              + String.valueOf(this.totalUni)
              + "@yel@ (@whi@"
