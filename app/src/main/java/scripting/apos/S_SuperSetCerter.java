...
/**
 * Start in yanille with any amount of any super set certs in your inventory or super sets in your
 * bank.
 *
 * <p>Parameters: uncert does just that, anything else certs.
 *
 * @author Stormy
 */
public final class S_SuperSetCerter extends Script {

  private static final int CERTER = 778, GNOMEBALL = 981, DOOR_SHUT = 2, DOOR_X = 603, DOOR_Y = 746;

  private static final int[] pots = {486, 495, 492};

  private static final int[] certs = {1273, 1274, 1275};
