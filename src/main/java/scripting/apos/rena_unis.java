...
public class rena_unis extends Script {
  int step = 0;
  int[] path = null;
  int loop = 0;
  int fightMode = 0;
  ...
  public int main() {
    ...
    if (!(this.walk_lumbydeath
      ...
      if (this.isAtApproxCoords(218, 446, 1)) {
        ...
        this.path =
            new int[] {
              206, 444, 191, 435, 191, 425, 191, 415, 190, 405, 191, 395, 191, 385, 191, 375, 191,
              361, 188, 353, 178, 344, 169, 336, 155, 326, 145, 317, 133, 307, 122, 299
            };
    ...
    if (!(this.walk_lumbydeath
      ...
      if (this.isAtApproxCoords(122, 299, 25)
          && !this.isAtApproxCoords(122, 299, 1)
          && !this.started) {
        this.walkTo(122, 299);
      ...
      if (this.isAtApproxCoords(122, 299, 1)) {
        ...
        this.path =
            new int[] {
              133, 307, 145, 317, 155, 326, 169, 336, 178, 344, 188, 353, 191, 361, 191, 375, 191,
              385, 191, 395, 190, 405, 191, 415, 191, 425, 191, 435, 206, 444, 218, 446, 216, 451
            };
