...
//        			break;
                        ...
                        if(lootPickedUp2) //we don't want to start to pickup loot then immediately attack a npc
                            continue;
                    }
    ...
    public void setupGUI() {
        ...
        startScriptButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
            	if(validateFields(npcIdsField, maxWanderField, eatAtHpField, lootTableField, spellNameField, arrowIdField, switchIdField)) {
            		setValuesFromGUI(fightModeField, npcIdsField, maxWanderField, eatAtHpField, lootTableField, openDoorsCheckbox, buryBonesCheckbox, prioritizeBonesCheckbox, magingCheckbox, spellNameField, rangingCheckbox, arrowIdField, switchIdField);
        ...
        buryBonesCheckbox.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
