 ...
 *
 * <p>todo add, "if fail agility shortcut" fallback? - currently bot may break.
 *
 * <p>Author - Kaila.
 */
    ...
    while (controller.isRunning()) {
      ...
      if (controller.getInventoryItemCount(526) > 0 && controller.getInventoryItemCount(527) > 0) {
        ...
        controller.useItemOnItemBySlot(
            controller.getInventoryItemSlotIndex(526), controller.getInventoryItemSlotIndex(527));
  ...
  public void paintInterrupt() {
    if (controller != null) {
      ...
      controller.drawString(
          "@whi@Dragonstones in Bank: @gre@" + String.valueOf(this.DragonstonesInBank),
          320,
          62,
          0xFFFFFF,
          1);
      controller.drawString(
          "@whi@Crystal Keys in Bank: @gre@" + String.valueOf(this.KeysInBank),
          320,
          76,
          0xFFFFFF,
          1);
      controller.drawString(
          "@whi@Dragonstones: @gre@"
              + String.valueOf(this.totalDragonstones)
              + "@yel@ (@whi@"
