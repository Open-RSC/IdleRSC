...
/**
 * Taverly Black Demons - Picks up the loot : rune battleaxe rune 2-h rune long rune chain rune med
 * rune kite rune sq dmed d sq half half keys chaos, deaths, blood, fire runes dragon stones - teles
 * falador to bank. - option to use ss - option to use food or pray pots
 *
 * <p>stormy notes: start next to either ladder added air runes and coins to pickups it's a good
 * idea to run this in a world where someone is killing blues (dragons don't hit that high but they
 * will make you lose one or two food without d shield or pray which is annoying)
 *
 * @author Storm
 */
public final class S_TavBlackDemons extends Script implements ActionListener {
  ...
  // script constants
  private static final int BANK_X = 328,
      BANK_Y = 552,
  ...
  private static final int[] pray_pots = {485, 484, PPOT_FULL};
  ...
  private static final int[] pickup_ids = {
    93, 81, 75, 400, 399, 404, 403, 795, 1277, 526, 527, 41, 619, 38, 31, 541, 523, AIR_RUNE, 10,
    LAW_RUNE
  };
  ...
  public S_TavBlackDemons(String ex) {
    //        super(ex);
