...
public class PotionDrinker extends IdleScript {
  ...
  public void setTheming() {
    ...
    strengthPotionCheckbox.setForeground(foregroundColor);
    strengthPotionCheckbox.setBackground(backgroundColor);
    attackPotionCheckbox.setForeground(foregroundColor);
    attackPotionCheckbox.setBackground(backgroundColor);
    statRestorePotionCheckbox.setForeground(foregroundColor);
    statRestorePotionCheckbox.setBackground(backgroundColor);
    DefensePotionCheckbox.setForeground(foregroundColor);
    DefensePotionCheckbox.setBackground(backgroundColor);
    RestorePrayerPotionCheckbox.setForeground(foregroundColor);
    RestorePrayerPotionCheckbox.setBackground(backgroundColor);
    SuperAttackPotionCheckbox.setForeground(foregroundColor);
    SuperAttackPotionCheckbox.setBackground(backgroundColor);
    FishingPotionCheckbox.setForeground(foregroundColor);
    FishingPotionCheckbox.setBackground(backgroundColor);
    SuperStrengthPotionCheckbox.setForeground(foregroundColor);
    SuperStrengthPotionCheckbox.setBackground(backgroundColor);
    SuperDefensePotionCheckbox.setForeground(foregroundColor);
    SuperDefensePotionCheckbox.setBackground(backgroundColor);
    RangingPotionCheckbox.setForeground(foregroundColor);
    RangingPotionCheckbox.setBackground(backgroundColor);
    CurePoisonPotionCheckbox.setForeground(foregroundColor);
    CurePoisonPotionCheckbox.setBackground(backgroundColor);
    ZamorakPotionCheckbox.setForeground(foregroundColor);
    ZamorakPotionCheckbox.setBackground(backgroundColor);
    SuperRunecraftPotionCheckbox.setForeground(foregroundColor);
    SuperRunecraftPotionCheckbox.setBackground(backgroundColor);
    RunecraftPotionCheckbox.setForeground(foregroundColor);
    RunecraftPotionCheckbox.setBackground(backgroundColor);
    MagicPotionCheckbox.setForeground(foregroundColor);
    MagicPotionCheckbox.setBackground(backgroundColor);
    SaradominPotionCheckbox.setForeground(foregroundColor);
    SaradominPotionCheckbox.setBackground(backgroundColor);
    SuperRangingPotionCheckbox.setForeground(foregroundColor);
    SuperRangingPotionCheckbox.setBackground(backgroundColor);
    SuperMagicPotionCheckbox.setForeground(foregroundColor);
    SuperMagicPotionCheckbox.setBackground(backgroundColor);
