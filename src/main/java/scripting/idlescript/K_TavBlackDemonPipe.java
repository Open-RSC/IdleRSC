 ...
 * Sharks/ppots/Laws/Airs/Earths IN BANK REQUIRED. super atk, super str pots suggested. 37 Magic
 * Required for tele, 37 prayer for paralize monster, 70 agility for shortcut. anti dragon shield
 * required. D2h recommended to demon kill rates don't suck.
 *
 * <p>Author - Kaila
 */
public class K_TavBlackDemonPipe extends IdleScript {
  ...
  public void paintInterrupt() {
    if (controller != null) {
      ...
      controller.drawString(
          "@whi@Rune Chain: @gre@"
              + String.valueOf(this.totalRchain)
              + "@yel@ (@whi@"
