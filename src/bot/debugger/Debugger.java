...
public class Debugger implements Runnable {
    ...
    private void initializeSections() {
        ...
        Class[] genericClassTypes = new Class[] { String.class, Integer.class, Integer.class, Integer.class, Integer.class };

        DebuggerSection objectsSection = new DebuggerSection(DebuggerSectionType.Objects, "Objects", genericColumnNames, 4);
        objectsSection.setColumnTypes(genericClassTypes);
        DebuggerSection npcsSection = new DebuggerSection(DebuggerSectionType.NPCs, "NPCs", genericColumnNames, 4);
        npcsSection.setColumnTypes(genericClassTypes);

        DebuggerSection playersSection = new DebuggerSection(DebuggerSectionType.Players, "Players", new String[] { "Name", "X", "Z", "Distance" }, 3);
        playersSection.setColumnTypes(new Class[] { String.class, Integer.class, Integer.class, Integer.class });

        DebuggerSection wallObjectsSection = new DebuggerSection(DebuggerSectionType.WallObjects, "Wall Objects", genericColumnNames, 4);
        wallObjectsSection.setColumnTypes(genericClassTypes);

        DebuggerSection inventoryItemsSection = new DebuggerSection(DebuggerSectionType.InventoryItems, "Inventory Items", new String[] { "Name", "ID", "Amount" }, 0);
        inventoryItemsSection.setColumnTypes(new Class[] { String.class, Integer.class, Integer.class, Integer.class, Integer.class });

        DebuggerSection groundItemsSection = new DebuggerSection(DebuggerSectionType.GroundItems, "Ground Items", new String[] { "Name", "ID", "Amount",  "X", "Z", "Distance" }, 5);
        groundItemsSection.setColumnTypes(new Class[] { String.class, Integer.class, Integer.class, Integer.class, Integer.class, Integer.class });

        DebuggerSection skillsSection = new DebuggerSection(DebuggerSectionType.Skills, "Skills", new String[] { "Name", "ID", "Current", "Base", "XP", "Gained XP" }, 0);
        skillsSection.setColumnTypes(new Class[] { String.class, Integer.class, Integer.class, Integer.class, Integer.class, Integer.class });
        ...
        DebuggerSection bankSection = new DebuggerSection(DebuggerSectionType.Bank, "Bank", bankShopColumnNames, 0);
        bankSection.setColumnTypes(bankShopColumnTypes);

        DebuggerSection shopSection = new DebuggerSection(DebuggerSectionType.Shop, "Shop", bankShopColumnNames, 0);
        shopSection.setColumnTypes(bankShopColumnTypes);

        DebuggerSection remoteTradeSection = new DebuggerSection(DebuggerSectionType.Recipient, "Recipient Trade", bankShopColumnNames, 0);
        remoteTradeSection.setColumnTypes(bankShopColumnTypes);

        DebuggerSection localTradeSection = new DebuggerSection(DebuggerSectionType.Local, "Local Trade", bankShopColumnNames, 0);
        ...
        DebuggerSection friendSection = new DebuggerSection(DebuggerSectionType.Friends, "Friends List", socialColumnNames, 0);
        friendSection.setColumnTypes(socialColumnTypes);

        DebuggerSection ignoreSection = new DebuggerSection(DebuggerSectionType.Ignore, "Ignore List", socialColumnNames, 0);
    ...
    private void updateInventoryItemsSection(Table table) {
        for(int i = 0; i < this.inventoryItems.size(); i++) {
            ...
            if(inventoryItem.getItemDef() != null) {
                Object[] row = {
                        inventoryItem.getItemDef().name,
                        inventoryItem.getItemDef().id,
    ...
    private void updateWallObjectsSection(Table table) {
        ...
        for(int i = 0; i < this.wallObjects.size(); i++) {
            ...
            int distanceFromLocalPlayer = controller.getDistanceFromLocalPlayer(wallObjectCoordX, wallObjectCoordZ);
    ...
    private void updateObjectsSection(Table table) {
        ...
        for(int i = 0; i < this.gameObjects.size(); i++) {
            ...
            int distanceFromLocalPlayer = controller.getDistanceFromLocalPlayer(gameObjectCoordX, gameObjectCoordZ);
    ...
    private void updatePlayersSection(Table table) {
        for(int i = 0; i < this.players.size(); i++) {
            ...
            int distanceFromLocalPlayer = controller.getDistanceFromLocalPlayer(playerCoordX, playerCoordZ);
