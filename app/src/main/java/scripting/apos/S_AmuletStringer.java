...
public final class S_AmuletStringer extends Script {
  ...
  private static final String[] names = {"dragonstone", "diamond", "ruby", "emerald", "sapphire"};

  private static final int[] unstrung_ids = {524, 300, 299, 298, 297};

  private static final int[] strung_ids = {610, 305, 304, 303, 302};
