...
public abstract class SeattaScript extends IdleScript {
  ...
  public final int colorDarkGray = 0x282A36;
  public final int colorWhite = 0xF8F8F2;
  public final int colorBlue = 0x6272A4;
  public final int colorCyan = 0x8BE9FD;
  public final int colorGreen = 0x50FA7B;
  public final int colorOrange = 0xFFB86C;
  public final int colorPink = 0xFF79C6;
  public final int colorPurple = 0xBD93F9;
  public final int colorRed = 0xFF5555;
  public final int colorYellow = 0xF1FA8C;

  // *    PaintBuilder Defaults and Variables
  public final int borderColor = colorPurple;
  public final int bgColor = colorDarkGray;
  public final int bgTransparency = 255;
  ...
  /**
   * Attempts to walk towards and opens the nearest bank
   *
   * @return boolean -- Whether the bank was opened
   */
  public static boolean openNearestBank() {
    if (c.isInBank()) return true;
    walkTowardsNearestBank();
    c.setStatus("Walking towards the nearest bank");
  ...
  public enum QuitReason {
    SCRIPT_STOPPED(null),
    MISSING_EQUIPPED_ITEM("You are missing a required to be equipped item:"),
