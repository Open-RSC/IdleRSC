...
public class Shrimp extends Script {
  ...
  public void init(String params) {
    if (!params.equals("")) sleepAt = Integer.parseInt(params);
  }
  ...
  public int main() {
    ...
    if (!isAtApproxCoords(418, 500, 5)
        && (getInventoryCount(350) + getInventoryCount(352) + getInventoryCount(353)) == 0
    ...
    if (isAtApproxCoords(433, 484, 5)
        && (getInventoryCount(352) + getInventoryCount(350) + getInventoryCount(353)) != 0) {
