...
public final class S_Certer extends Script implements ActionListener {
  ...
  public void init(String params) {
    System.out.println(
        "RECOMMENDED: Make sure the first 5 slots of your inventory are always occupied.");
    if (frame == null) {
          ...
          if (bankCount(item.getCertId()) > 5) {
            if (uncert_time != -1L) {
              if (getInventoryCount() != expected_invcount
                  || getInventoryCount(item.getCertId()) != expected_certcount) {
            ...
            System.out.println("Out of certificates, stopping...");
            stopScript();
            setAutoLogin(false);
            return 0;
          }
  ...
  private int doYanille() {
    ...
    if (isQuestMenu()) {
      int index = getMenuIndex(uncert ? "Five Certificates Please." : "Twenty Five");
      if (index != -1) {
    ...
    int[] certer = getNpcByIdNotTalk(item.getCerterIds());
    if (certer[0] != -1) {
      int index = getInventoryIndex(uncert ? item.getCertId() : item.getItemId());
      if (index != -1) {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    switch (choice.getSelectedIndex()) {
      case 0:
        item = new CertOption(new int[] {299}, 546, 630, "fish", "shark");
        break;
      case 1:
        item = new CertOption(new int[] {299}, 545, 631, "fish", "Raw shark");
        break;
      case 2:
        item = new CertOption(new int[] {299}, 555, 628, "fish", "bass");
        break;
      case 3:
        item = new CertOption(new int[] {299}, 554, 629, "fish", "Raw bass");
        break;
      case 4:
        item = new CertOption(new int[] {341}, 635, 711, "logs", "yew logs");
        break;
      case 5:
        item = new CertOption(new int[] {341}, 634, 712, "logs", "maple logs");
        break;
      case 6:
        item = new CertOption(new int[] {341}, 633, 713, "logs", "willow logs");
        break;
      case 7:
        item = new CertOption(new int[] {778}, 483, 1272, null, "Prayer Restore Potion");
        break;
      case 8:
        item = new CertOption(new int[] {778}, 486, 1273, null, "Super Attack Potion");
        break;
      case 9:
        item = new CertOption(new int[] {778}, 495, 1274, null, "Super Defense Potion");
        break;
      case 10:
        item = new CertOption(new int[] {778}, 492, 1275, null, "Super Strength Potion");
        break;
      case 11:
        item = new CertOption(new int[] {778}, 814, 1270, null, "Dragon Bones");
        break;
      case 12:
        item = new CertOption(new int[] {778}, 220, 1271, null, "Limpwurt Root");
        break;
      case 13:
        item = new CertOption(new int[] {226, 467}, 170, 528, "bars", "iron");
        break;
      case 14:
        item = new CertOption(new int[] {226, 467}, 171, 529, "bars", "steel");
        break;
      case 15:
        item = new CertOption(new int[] {226, 467}, 173, 530, "bars", "mithril");
        break;
      case 16:
        item = new CertOption(new int[] {226, 467}, 172, 532, "bars", "Gold");
        break;
      case 17:
        item = new CertOption(new int[] {226, 467}, 384, 531, "bars", "silver");
        break;
      case 18:
        item = new CertOption(new int[] {225, 466}, 151, 517, "ore", "iron");
        break;
      case 19:
        item = new CertOption(new int[] {225, 466}, 155, 518, "ore", "Coal");
        break;
      case 20:
        item = new CertOption(new int[] {225, 466}, 153, 519, "ore", "mithril");
        break;
      case 21:
        item = new CertOption(new int[] {225, 466}, 152, 521, "ore", "Gold");
        break;
      case 22:
        item = new CertOption(new int[] {225, 466}, 383, 520, "ore", "silver");
        break;
      case 23:
        item = new CertOption(new int[] {227}, 373, 533, "fish", "Lobster");
        break;
      case 24:
        item = new CertOption(new int[] {227}, 372, 534, "fish", "Raw Lobster");
        break;
      case 25:
        item = new CertOption(new int[] {227}, 370, 535, "fish", "swordfish");
        break;
      case 26:
        item = new CertOption(new int[] {227}, 369, 536, "fish", "Raw swordfish");
        break;
    }
    String str =
  ...
  public void paint() {
    ...
    y += 15;
    drawString(
        getItemsCerted(), 25, y, 1, white); // Display number of items certed or certs uncerted
    y += 15;
  ...
  private String getItemsCerted() {
    ...
    if (uncert) {
      return String.format(
          ...
          items_certed,
          total_items,
          getItemNameId(item.getCertId()),
          getPercent(items_certed, total_items));
    } else {
      return String.format(
          "Certed: %d/%d %s (%d%%)",
          items_certed, total_items, item.getItemName(), getPercent(items_certed, total_items));
    }
  }
  ...
  private static final class CertOption {
    ...
    CertOption(int[] certer_ids, int item_id, int cert_id, String type, String option) {
