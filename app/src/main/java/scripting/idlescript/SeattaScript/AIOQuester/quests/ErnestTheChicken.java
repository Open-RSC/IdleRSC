...
public final class ErnestTheChicken extends QuestHandler {
  ...
  private final int[] DRAYNOR_MANOR_DOOR_ONE = {210, 556};
  private final int[] DRAYNOR_MANOR_DOOR_TWO = {210, 553}; // wall object door
  private final int[] DRAYNOR_MANOR_DOOR_THREE = {213, 545};
  private final int[] DRAYNOR_MANOR_DOOR_FOUR = {199, 551};
  private final int[] DRAYNOR_MANOR_DOOR_FIVE = {217, 543};
  private final int[] DRAYNOR_MANOR_DOOR_SIX = {220, 547};
  private final int[] DRAYNOR_MANOR_DOOR_SEVEN = {215, 550};
  private final int[] DRAYNOR_MANOR_CLOSET = {212, 545};
  private final int[] DRAYNOR_MANOR_F2_DOOR_ONE = {207, 1495};
  private final int[] DRAYNOR_MANOR_F2_DOOR_TWO = {209, 1497};
  private final int[] DRAYNOR_MANOR_F3_DOOR = {211, 2438};
  private final int[] DRAYNOR_MANOR_STAIRS_UP = {210, 547};
  private final int[] DRAYNOR_MANOR_STAIRS_DOWN = {210, 1491};
  private final int[] DRAYNOR_MANOR_LADDER_UP = {215, 1492};
  private final int[] DRAYNOR_MANOR_LADDER_DOWN = {215, 2436};
  private final int[] DRAYNOR_MANOR_LADDER_DOWN_BASEMENT = {223, 553};
  private final int[] DRAYNOR_MANOR_LADDER_UP_BASEMENT = {223, 3385};
  private final int[] COMPOST_HEAP = {230, 552};
  private final int[] FOUNTAIN = {226, 565};

  private final int[] DRAYNOR_MANOR_LEVER_A = {225, 3386};
  private final int[] DRAYNOR_MANOR_LEVER_B = {222, 3382};
  private final int[] DRAYNOR_MANOR_LEVER_C = {222, 3378};
  private final int[] DRAYNOR_MANOR_LEVER_D = {223, 3375};
  private final int[] DRAYNOR_MANOR_LEVER_E = {229, 3375};
  private final int[] DRAYNOR_MANOR_LEVER_F = {230, 3376};
  private final int[] DRAYNOR_MANOR_DOOR_A = {223, 3381};
  private final int[] DRAYNOR_MANOR_DOOR_B = {225, 3379};
  private final int[] DRAYNOR_MANOR_DOOR_C = {225, 3376};
  private final int[] DRAYNOR_MANOR_DOOR_D = {226, 3378};
  private final int[] DRAYNOR_MANOR_DOOR_E = {226, 3381};
  private final int[] DRAYNOR_MANOR_DOOR_F = {228, 3379};
  private final int[] DRAYNOR_MANOR_DOOR_G = {228, 3376};
  private final int[] DRAYNOR_MANOR_DOOR_H = {229, 3378};
  private final int[] DRAYNOR_MANOR_DOOR_I = {228, 3382};

  // ITEM IDS
  private final int FISH_FOOD_ID = ItemId.FISH_FOOD.getId();
  private final int PRESSURE_GAUGE_ID = ItemId.PRESSURE_GAUGE.getId();
  private final int RUBBER_TUBE_ID = ItemId.RUBBER_TUBE.getId();
  private final int SPADE_ID = ItemId.SPADE.getId();
  private final int CLOSET_KEY_ID = ItemId.CLOSET_KEY.getId();
  private final int OIL_CAN_ID = ItemId.OIL_CAN.getId();
  private final int POISON_ID = ItemId.POISON.getId();
  private final int POISON_FOOD_ID = ItemId.POISONED_FISH_FOOD.getId();

  // NPC IDS
  private final int VERONICA_ID = NpcId.VERONICA.getId();
  private final int ODDENSTEIN_ID = NpcId.PROFESSOR_ODDENSTEIN.getId();

  // NPC DIALOGS
  private final String[] STEP_ONE_START_QUEST_DIALOG = {"Aha, sounds like a quest. I'll help"};
  private final String[] STEP_TWO_QUEST_DIALOG = {
