...
public final class S_ArdBuyVials extends Script {
  ...
  public S_ArdBuyVials(String ex) {
    //		super(ex);
  ...
  public void paint() {
    ...
    drawString(
        String.format(
            "S Filled Vial Buyer | Bought: %s (%s/h)", iformat.format(count), per_hour(count)),
        x,
        y,
        2,
        0xFFFFFF);
  ...
  private int _odd() {
    System.out.println("something odd happened. i'm here: " + getX() + "," + getY());
    return random(1000, 2000);
  }
