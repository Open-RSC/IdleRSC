...
public final class HighAlcher extends Script {
  ...
  public void init(String params) {
    try {
      ...
      System.out.println("Error parsing parameters. " + "Example: itemid1,id2,id3...");
      return;
    }
  ...
  public int main() {
    ...
    if (target == -1 || staff == -1 || !hasInventoryItem(ID_NATURE)) {
      if (distanceTo(bankChest.x, bankChest.y) < 5) {
        atObject(bankChest.x, bankChest.y);
        return 600;
      }
  ...
  public void paint() {
    ...
    for (int i = 0; i < num; ++i) {
      ...
      drawString("Withdrawn " + itm_count[i] + " " + itm_name[i], 25, y, 1, gray);
      y += 15;
    }
