...
public class Config {
  ...
  */
  ...
  public void printUsage() {
    System.out.println(
        "Example usage: java -jar IdleRSC.jar --username pengu --password l33th4x0r");
  ...
  private void handleLegacyArgs(String[] clientArgs) {
    ...
    if (clientArgs.length == 2) {
      System.out.println(
          "Change args to \"--username \"" + username + "\" --password \"" + password + "\"\"");
    } else if (clientArgs.length == 3) {
      System.out.println(
          "Change args to \"--username \""
              + username
              + "\" --password \""
              + password
              + "\" --script \""
      ...
      System.out.println(
          "Change args to \"--username \""
              ...
              + scriptName
              + "\" --scriptarguments "
              + String.join(" ", Arrays.copyOfRange(clientArgs, 3, clientArgs.length))
              + "\"");
    }
  }
      ...
      switch (clientArgs[argIndex].toLowerCase()) {
        ...
        default:
          if (clientArgs[argIndex].startsWith("--")) {
            System.out.println(
                "Unknown client argument \"" + clientArgs[argIndex] + "\"... Ignoring!");
          } else {
