...
public enum ItemId implements Id {
  ...
  EMERALD(163),
  SAPPHIRE(164),
  UNID_GUAM_HERB(165), // unif guam leaf
  TINDERBOX(166),
  CHISEL(167),
  HAMMER(168),
  BRONZE_BAR(169),
  ...
  RATS_TAIL(271),
  BLUEDYE(272),
  GOBLIN_ARMOUR_NORMAL(273),
  GOBLIN_ARMOUR_BROWN(274),
  GOBLIN_ARMOUR_BLUE(275),
  ...
  UNID_MARRENTILL(435), // unidentified Marrentill
  UNID_TARROMIN(436), // unidentified Tarromin
  UNID_HARRALANDER(437), // unidentified Harralander
  UNID_RANARR(438), // unidentified Ranarr Weed
  UNID_IRIT(439), // unidentified Irit Leaf
  UNID_AVANTOE(440), // unidentified Avantoe
  UNID_KWUARM(441), // unidentified Kwuarm
  UNID_CADANTINE(442), // unidentified Cadantine
  UNID_DWARF(443), // unidentified Dwarf Weed
  GUAM_LEAF(444),
  MARRENTILL(445),
  TARROMIN(446),
  HARRALANDER(447),
  ...
  CADANTINE(452),
  DWARF_WEED(453),
  UNF_GUAM_POTION(454), //UNFINISHED_POTION
  UNF_MARRANTILL_POTION(455), //UNFINISHED_POTION
  UNF_TARROMIN_POTION(456), //UNFINISHED_POTION
  UNF_HARRALANDER_POTION(457), //UNFINISHED_POTION
  UNF_RANARR_POTION(458), //UNFINISHED_POTION
  UNF_IRIT_POTION(459), //UNFINISHED_POTION
  UNF_AVANTOE_POTION(460), //UNFINISHED_POTION
  UNF_KWUARM_POTION(461), //UNFINISHED_POTION
  UNF_CADANTINE_POTION(462), //UNFINISHED_POTION
  UNF_DWARF_POTION(463), //UNFINISHED_POTION
  WATER_VIAL(464),
  EMPTY_VIAL(465),
  UNICORN_HORN(466),
  ...
  ATTACK_POTION_3DOSE(474),
  ATTACK_POTION_2DOSE(475),
  ATTACK_POTION_1DOSE(476),
  STAT_RESTORATION_POTION_3DOSE(477),
  STAT_RESTORATION_POTION_2DOSE(478),
  STAT_RESTORATION_POTION_1DOSE(479),
  DEFENSE_POTION_3DOSE(480),
  DEFENSE_POTION_2DOSE(481),
  DEFENSE_POTION_1DOSE(482),
  RESTORE_PRAYER_POTION_3DOSE(483),
  RESTORE_PRAYER_POTION_2DOSE(484),
  RESTORE_PRAYER_POTION_1DOSE(485),
  SUPER_ATTACK_POTION_3DOSE(486),
  SUPER_ATTACK_POTION_2DOSE(487),
  SUPER_ATTACK_POTION_1DOSE(488),
  FISHING_POTION_3DOSE(489),
  FISHING_POTION_2DOSE(490),
  FISHING_POTION_1DOSE(491),
  SUPER_STRENGTH_POTION_3DOSE(492),
  SUPER_STRENGTH_POTION_2DOSE(493),
  SUPER_STRENGTH_POTION_1DOSE(494),
  SUPER_DEFENSE_POTION_3DOSE(495),
  SUPER_DEFENSE_POTION_2DOSE(496),
  SUPER_DEFENSE_POTION_1DOSE(497),
  RANGING_POTION_3DOSE(498),
  RANGING_POTION_2DOSE(499),
  RANGING_POTION_1DOSE(500),
  WINE_OF_ZAMORAK(501),
  RAW_BEAR_MEAT(502),
  RAW_RAT_MEAT(503),
  RAW_BEEF(504),
  ...
  CURE_POISON_POTION_3DOSE(566),
  CURE_POISON_POTION_2DOSE(567),
  CURE_POISON_POTION_1DOSE(568),
  POISON_ANTIDOTE_3DOSE(569),
  POISON_ANTIDOTE_2DOSE(570),
  POISON_ANTIDOTE_1DOSE(571),
  WEAPON_POISON(572),
  ID_PAPER(573),
  ...
  PERFECT_GOLD_ORE(690),
  PERFECT_GOLD_BAR(691),
  PERFECT_RUBY_RING(692),
  PERFECT_RUBY_NECKLACE(693),
  FAMILY_CREST(694),
  CREST_FRAGMENT_695(695),
  ...
  LARGE_BLUE_COG(727),
  LARGE_SILVER_COG(728),
  LARGE_RED_COG(729),
  LARGE_PURPLE_COG(730),
  RAT_POISON(731),
  SHINY_KEY(732),
  KHAZARD_HELMET(733),
  ...
  BONE_KEY(835),
  PINK_GNOME_ROBE(836),
  GREEN_GNOME_ROBE(837),
  PURPLE_GNOME_ROBE(838),
  YELLOW_GNOME_ROBE(839),
  BLUE_GNOME_ROBE(840),
  PINK_GNOMESHAT(841),
  GREEN_GNOMESHAT(842),
  PURPLE_GNOMESHAT(843),
  YELLOW_GNOMESHAT(844),
  BLUE_GNOMESHAT(845),
  PINK_GNOME_TOP(846),
  GREEN_GNOME_TOP(847),
  PURPLE_GNOME_TOP(848),
  YELLOW_GNOME_TOP(849),
  BLUE_GNOME_TOP(850),
