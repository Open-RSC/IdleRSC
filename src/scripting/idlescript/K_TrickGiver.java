 ...
 *
 *      Opens Trick or' Treat Cracker by using them on a 2nd account.
 *      Used in conjunction with K_GiftTaker Script!
 *
...
public class K_TrickGiver extends IdleScript {
	...
	public int start(String parameters[]) {
        ...
        controller.displayMessage("@red@Directions inside K_TrickGiver.java file");
		...
		while(controller.isRunning()) {
			...
			if(controller.getInventoryItemCount() < 30 && controller.getInventoryItemCount(1330) > 1) {
				...
				controller.useItemOnPlayer(1,controller.getPlayerServerIndexByName("ExampleAccountName"));  //replace the player name
