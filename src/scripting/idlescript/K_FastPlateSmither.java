 ...
 *
 * <p>Start with Hammer in Inv! Batch Bars MUST be toggled ON in settings!!! This ensures 5 Plates
 * are made per Menu Cycle. Supports all bar types.
 *
 * <p>This bot supports the \"autostart\" parameter. defaults to steel plates.
 *
 * <p>Parameters for Starting: auto, autostart - makes steel platebodies. bronze - makes bronze
 * platebodies. iron - makes iron platebodies. steel - makes steel platebodies. mith, mithril -
 * makes mithril platebodies. addy, adamantite - makes adamantite platebodies. rune, runite - makes
 * runite platebodies.
 *
 * <p>Author - Kaila
 */
  ...
  public void paintInterrupt() {
    if (c != null) {
      ...
      c.drawString(
          ...
          1);
      c.drawString(
          "@whi@Time Remaining: " + toTimeToCompletion(totalBars, barsInBank, startTime),
          x,
          y + (14 * 6),
          0xFFFFFF,
          1);
