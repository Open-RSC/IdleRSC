...
final class Line {
  ...
  double getDistance(Line l) {
    ...
    return Math.abs((double) a * x + (double) b * y + (double) c)
  ...
  Point intersect(Line l) {
    double x, y;
    x =
        ((double) c * (double) l.b - (double) l.c * (double) b)
            / ((double) l.a * (double) b - (double) a * (double) l.b);
    y =
        ((double) c * (double) l.a - (double) l.c * (double) a)
