...
public final class SheepShearer extends QuestHandler {

  // COORDINATES FOR walkPath() PATHS AND pickupUnreachableItem()
  private final int[] GENERAL_STORE_OUTER = {131, 641};
  private final int[] GENERAL_STORE_INNER = {133, 641};
  private final int[] FRED_HOUSE_OUTER = {159, 616};
  private final int[] FRED_HOUSE_INNER = {159, 617};
  private final int[] FRED_GATE_OUTER = {159, 614};
  private final int[] FRED_GATE_INNER = {159, 615};
  private final int[] COURTYARD_OUTER = {128, 658};
  private final int[] COURTYARD_INNER = {129, 658};
  private final int[] SHEEP_PEN_OUTER = {135, 630};
  private final int[] SHEEP_PEN_INNER = {136, 630};
  private final int[] ROAD_CABBAGES = {144, 616};
  private final int[] ROAD_FURNACE = {134, 626};
  private final int[] ROAD_CORNER = {135, 617};
  private final int[] LADDER = {139, 667};
  ...
  private final int[][] GENERAL_STORE_TO_SHEEP = {
    GENERAL_STORE_INNER, GENERAL_STORE_OUTER, SHEEP_PEN_OUTER, SHEEP_PEN_INNER
  };
  private final int[][] COURTYARD_TO_SHEEP = {
    COURTYARD_OUTER, GENERAL_STORE_OUTER, SHEEP_PEN_OUTER, SHEEP_PEN_INNER
  };
  private final int[][] COURTYARD_TO_GENERAL_STORE = {
    COURTYARD_OUTER, GENERAL_STORE_OUTER, GENERAL_STORE_INNER
  };
  private final int[][] COURTYARD_TO_LADDER = {COURTYARD_OUTER, COURTYARD_INNER, LADDER};

  // OBJECT COORDINATES
  private final int[] LADDER_UP_GROUND_FLOOR = {139, 666};
  private final int[] LADDER_UP_SECOND_FLOOR = {138, 1612};
  private final int[] LADDER_DOWN_THIRD_FLOOR = {138, 2556};
  private final int[] LADDER_DOWN_SECOND_FLOOR = {139, 1610};
  private final int[] SPINNING_WHEEL = {139, 2554};

  // OBJECT SEQUENCES
  private final int[][] UP_LADDER = {LADDER_UP_GROUND_FLOOR, LADDER_UP_SECOND_FLOOR};
  private final int[][] DOWN_LADDER = {LADDER_DOWN_THIRD_FLOOR, LADDER_DOWN_SECOND_FLOOR};

  // ITEM IDS
  private final int WOOL_ID = ItemId.WOOL.getId();
  private final int BALL_OF_WOOL_ID = ItemId.BALL_OF_WOOL.getId();
  private final int SHEARS_ID = ItemId.SHEARS.getId();

  // NPC IDS
  private final int SHEEP_ID = NpcId.SHEEP.getId();
  private final int FRED_ID = NpcId.FRED_THE_FARMER.getId();

  // NPC DIALOGS
  private final String[] FRED_START_QUEST_DIALOG = {
